...
print(station_data[2019]['longitude'].unique())

gdf = geopandas.GeoDataFrame(
    station_data[2019], geometry=geopandas.points_from_xy(station_data[2019].longitude, station_data[2019].latitude), crs="EPSG:4326"
)
...
ax = world.clip([-120, 25, -100, 40]).plot(color="white", edgecolor="black")
