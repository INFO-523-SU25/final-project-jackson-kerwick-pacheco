...
| **Aug 15** | Model Tuning & Evaluation | Perform hyperparameter tuning for regression models. Compare linear vs. quadratic fits. Assess model performance using R², RMSE, and residual analysis. |
