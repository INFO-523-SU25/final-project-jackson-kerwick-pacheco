...
for i in range(2019, 2023):
  year = ":02",format(i)
  for j in range(1,13):
    fname = f"data/Traffic/counts/AZ{:02}{year}.VOL".format(j)
    df_count = pd.read_csv(fname)


# Combining hourly counts into a sum over each day
...
df_per_station = df_count.groupby("Station_Id")['daily_volume']
