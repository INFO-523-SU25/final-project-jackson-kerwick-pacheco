...
# Add County Info for storm df merging
...
# Need to add geometry of gridspace to gdf_traffic
gdf_traffic = add_grid_geometry(gdf_traffic)

# Plot traffic data with grid geometry
...
- Our PCA analysis demonstrates that extreme storm events and temperature have the most significant interaction amongst features in our dataset.
